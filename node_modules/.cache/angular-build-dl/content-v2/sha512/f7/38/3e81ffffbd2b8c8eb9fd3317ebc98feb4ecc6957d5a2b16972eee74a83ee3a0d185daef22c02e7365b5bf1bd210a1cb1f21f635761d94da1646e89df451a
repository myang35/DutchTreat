...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function ClientAppAppShopCartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    Cart.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 21,
      vars: 8,
      consts: [[1, "table", "table-condensed", "table-hover"], [4, "ngFor", "ngForOf"], ["routerLink", "checkout", "class", "btn btn-success", 3, "click", 4, "ngIf"], ["routerLink", "checkout", 1, "btn", "btn-success", 3, "click"]],
  ...
  function ClientAppAppShopProductListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ProductList.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [[1, "row"], ["class", "product-info col-md-4", 4, "ngFor", "ngForOf"], [1, "product-info", "col-md-4"], [1, "img-fluid", 3, "src", "alt"], [1, "product-name"], [1, "product-props"], ["id", "buyButton", 1, "btn", "btn-success", "btn-sm", "pull-right", 3, "click"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\marvi\Desktop\AspnetcoreExamples\DutchTreat\ClientApp\main.ts */
    "./ClientApp/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
